...
def continual_clip(cfg: DictConfig) -> None:
    ...
    zscl_model = CLIPModel.from_pretrained(cfg.model_name)
    zscl_model.cuda()
    zscl_model.eval()
    ...
    for task_id, _ in enumerate(test_dataset):
        ...
        zscl_model.load_state_dict(ckp)
        zscl_model.cuda()
        model.model.cuda()
        ...
        for inputs,targets,task_ids,names   in tqdm(test_loader):
            ...
            all_output =zscl_model(model.text_tokens0,inputs)
