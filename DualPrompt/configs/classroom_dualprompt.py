...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--shot', default=5, type=int)
    ...
    subparsers.add_argument('--dataset', default='classroom', type=str, help='dataset name')
    ...
    subparsers.add_argument('--nb_classes', type=int, default=100, help = 'The frequency of printing')