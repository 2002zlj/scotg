...
def build_classroom_dataloader_ZLJ(args):
    from classroom import ClassRoom, fscil_class,ClassRoom_ZLJ
    dataloader = list()
    class_mask = list() 
    class_mask = fscil_class[3]  #B2
    for i in range(len(class_mask)):
        fs_trainset = ClassRoom_ZLJ(fscil=True, train=True, classroom_type = 'vit_b2', session = i, f_shot= args.shot)
    #     print(len(fs_trainset))
        fs_testset = ClassRoom_ZLJ(fscil=True, train=False, classroom_type = 'vit_b2', session = i, f_shot= args.shot)
...
def build_classroom_dataloader(args):
    from classroom import ClassRoom, fscil_class
    dataloader = list()
    class_mask = list() 
    class_mask = fscil_class[1]
    for i in range(len(class_mask)):
        fs_trainset = ClassRoom(fscil=True, train=True, classroom_type = 'vit_a2', session = i, f_shot= 5)
    #     print(len(fs_trainset))
        fs_testset = ClassRoom(fscil=True, train=False, classroom_type = 'vit_a2', session = i, f_shot= 5)
